...
foreach ($film_post_types as $post_type) {
    ...
    add_filter($hook_name, function($response, $post) {
        $acf_fields = array(
            ...
            'image_popup_1' => get_field('image_popup_1', $post->ID, false),
            'image_popup_2' => get_field('image_popup_2', $post->ID, false),
            'image_popup_3' => get_field('image_popup_3', $post->ID, false),
            'image_popup_4' => get_field('image_popup_4', $post->ID, false),
            'image_popup_5' => get_field('image_popup_5', $post->ID, false),
